...
export const deleteFaculty = async (req, res) => {
  try {
    ...
    return res.json({ success: true, message: "Faculty Deleted Successfully", data: response });
  } catch (error) {
    console.error("Error While Deleting the faculty:", error);
    return res.json({ success: false, message: "Error while deleting the faculty" });
  }
};
